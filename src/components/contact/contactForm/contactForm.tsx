        ...
        <div className='pt-[70px]'>
            ...
            <div className='xl:w-[40vw] border-[15px] flex ml-[auto] mr-[auto] justify-center rounded-[15px] bg-white py-[20px] shadow-inner shadow-gray-900'>
                ...
                <div className='text-center text-[40px] py-[20px]' >Contact Us</div>
                    ...
                    <button className='text-center border-2 bg-red flex mx-[auto] mt-[20px] px-[35px] py-[10px] text-[25px] mt-[50px] mb-[20px] rounded-[15px] bg-gray-100 hover:bg-gray-200 shadow-md shadow-gray-900 border-[3px]'>Submit</button>
