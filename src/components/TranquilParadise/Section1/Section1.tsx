...
import innerHeroImg from "../../../common/assets/images/innerPageImage/drone1.jpg";
    ...
    <div className="relative">
      ...
      <div className="absolute inset-0 flex flex-col items-center text-center text-white pt-[10%]">
        ...
        >
          ...
          <br /> */}
          <span className="text-[5.66vw] font-[400]">Tranquil Paradise :- </span>
          <br />
          <span className="text-[6.66vw] font-[400]">Whispers of Sporting Elegance</span>
          <br />
        </div>
        <div className="text-[2vw] font-[400] text-black drop-shadow-2xl">A Mesmeric 9-Day Visit</div>
      </div>
    </div>
  );
}
