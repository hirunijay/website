    ...
    <div className="relative">
      ...
      <div className="absolute inset-0 flex flex-col items-center text-center text-white pt-[10%]">
        ...
        >
          ...
          <br /> */}
          <span className="text-[10.66vw] font-[400]">A Sporting</span>
          <br />
          <span className="text-[10.66vw] font-[400]">Euphoria </span>
          <br />
        </div>
        <div className="text-[2vw] font-[400] text-black drop-shadow-2xl">A 9-Day Odyssey</div>
      </div>
    </div>
  );
}
