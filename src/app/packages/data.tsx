// Golfing Serenity
import heroImageP1 from "@/common/assets/images/homeImg/mainBanner.jpg";
import desImageP1 from "@/common/assets/images/sliderImages/golfsection.jpg";
import detailImageP1 from "@/common/assets/images/GridImages/img1.jpg";
...
export const packageData = {
  GolfingSerenity: {
    ...
    detailSection: {
      detailImage: detailImageP1,
      footerContent:
        "Tranquil Paradise beckons, where the greens of golf unite with the blues of oceans and skies, and where every moment etches itself into the canvas of your heart.",
      detailContent: [
        {
  ...
  Windswept: {
    ...
    detailSection: {
      detailImage: detailImageP2,
      footerContent:
        "Tranquil Paradise invites you to pedal through the symphonies of Sri Lanka's heartland, where mountains echo with your courage, and memories linger like the fragrance of adventure.",
      detailContent: [
        {
        ...
        },
        {
          ...
          description: `Kandy City Tour / Food Odyssey / Evening Stroll
        ...
        {
          title:
            "Day 03 - Knuckles Mountain Symphony: Professional & Intermediate",
          description: `Professionals: 30KM / Intermediate: 15KM
        ...
        },
        {
          ...
          description: `Professionals: 25 - 30KM / Intermediate: 15KM
